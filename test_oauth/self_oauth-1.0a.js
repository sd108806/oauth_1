...
*/
   ...
   document.write("opts.signature_method " + opts.signature_method + "<br/>");
   
   document.write("this.consumer.key " + this.consumer.key + "<br/>");
document.write("this.signature_method " + this.signature_method + "<br/>");
document.write("this.nonce_length " + this.nonce_length + "<br/>");
document.write("this.version " + this.version + "<br/>");
document.write("this.parameter_seperator " + this.parameter_seperator + "<br/>"+"<br/>"+"<br/>");
...
//change
//var base_string_data = this.sortObject(this.percentEncodeData(this.mergeObject(oauth_data, request.url)));
	//add
	document.write("base_string_data" +base_string_data[0]+"<br/>"+"<br/>");
